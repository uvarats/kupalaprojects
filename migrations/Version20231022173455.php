 ...
 */
final class Version20231022173455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team DROP accepted');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team ADD accepted BOOLEAN DEFAULT false NOT NULL');
