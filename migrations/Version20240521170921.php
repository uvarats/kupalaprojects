 ...
 */
final class Version20240521170921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project_report (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, project_id UUID DEFAULT NULL, PRIMARY KEY(id))');
