...
class ParticipantRepository extends ServiceEntityRepository
{
    ...
    public function getParticipantsWithoutDecision(Project $project): ParticipantCollection
    {
        $result = $this->createQueryBuilder('participant')
            ->where('participant.acceptance = :acceptance')
